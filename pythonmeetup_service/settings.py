"""
Django settings for pythonmeetup_service project.
...
# Load .env from project root via environs[django]
env = Env()
...
ROOT_URLCONF = 'pythonmeetup_service.urls'
...
WSGI_APPLICATION = 'pythonmeetup_service.wsgi.application'
